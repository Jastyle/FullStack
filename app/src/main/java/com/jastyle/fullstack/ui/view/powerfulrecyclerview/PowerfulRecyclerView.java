package com.jastyle.fullstack.ui.view.powerfulrecyclerview;
...
import com.jastyle.fullstack.utils.DimenUtil;
...
public class PowerfulRecyclerView extends RecyclerView {
    ...
    public PowerfulRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        mDividerSize = ta.getDimensionPixelSize(R.styleable.PowerfulRecyclerView_dividerSize, DimenUtil.dip2Px(context,1));
